FUNCTION FUN_0000f578 @ 0x0000f578 size=232
CALLERS (0): 
CALLEES (2): FUN_0000d3d4@0x0000d3d4, FUN_0000d41c@0x0000d41c

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

int FUN_0000f578(int *param_1,undefined4 param_2)

{
  ...
  if (iVar1 == 0) {
    ...
    iVar1 = -0x200;
    if (piVar2 != (int *)0x0) {
      if ((code *)piVar2[1] == FUN_00000000) {
        iVar1 = -0x201;
      }
      else {
        iVar1 = (*(code *)piVar2[1])(param_1,param_2);
      }
    }
    FUN_0000d41c();
  }
