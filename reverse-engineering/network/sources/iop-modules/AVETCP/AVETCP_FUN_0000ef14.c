...
CALLEES (4): FUN_0000139c@0x0000139c, FUN_000010c0@0x000010c0, FUN_00001454@0x00001454, FUN_00011da8@0x00011da8
    ...
    if (param_1 != 0) {
      while (0xf < param_1) {
        while( true ) {
          ...
          if (((&DAT_0001835e)[sVar3 * 0xe] & 1) != 0) break;
          sVar3 = sVar3 + 1;
        }
        iVar2 = (int)sVar3;
        ...
        local_38 = (&DAT_00018350)[iVar2 * 7];
        local_34 = (&DAT_00018358)[iVar2 * 7];
        local_30 = (&DAT_0001835c)[iVar2 * 0xe];
        local_2e = (&DAT_0001835e)[iVar2 * 0xe];
        local_2c = 1;
