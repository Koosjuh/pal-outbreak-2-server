...
CALLEES (6): FUN_000124b8@0x000124b8, FUN_0000d9c8@0x0000d9c8, FUN_00011e58@0x00011e58, FUN_000013ac@0x000013ac, FUN_00012090@0x00012090, FUN_00012490@0x00012490
...

{
  ...
  if ((*param_1 < (short)(ushort)DAT_0001619b) && (-1 < *param_1)) {
    ...
    if (*(byte *)((int)param_1 + 9) < 5) {
      ...
      iVar2 = 0;
      if (local_ac != 0) {
        *(undefined2 *)(&DAT_00018830 + *param_1 * 0xc) = 0xffff;
        *(short *)(&DAT_00018834 + *param_1 * 0xc) = *param_1;
        if (*(int *)(param_1 + 2) == 0) {
          FUN_00011e58(&DAT_00018838 + *param_1 * 3);
          if ((&DAT_00018838)[*param_1 * 3] == -1) {
            return -0x4d2;
          }
        }
        else {
          (&DAT_00018838)[*param_1 * 3] = 0xffffffff;
        }
        ...
        if (iVar2 < 0) {
          ...
          if (*(int *)(param_1 + 2) == 0) {
            FUN_000124b8();
            sVar1 = *(short *)(&DAT_00018830 + *param_1 * 0xc);
            while (sVar1 == -1) {
              FUN_00012090();
              sVar1 = *(short *)(&DAT_00018830 + *param_1 * 0xc);
            }
            FUN_00012490();
            (&DAT_00018838)[*param_1 * 3] = 0xffffffff;
            iVar2 = (int)*(short *)(&DAT_00018832 + *param_1 * 0xc);
          }
        }
      }
    }
