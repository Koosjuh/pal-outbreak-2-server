...

{
  ...
  iVar2 = FUN_00004254((int)*(short *)(&DAT_00018364 + iVar3 * 7));
  if (iVar2 != 0) {
    iVar4 = (&DAT_00018358)[iVar3 * 7];
    if (*(int *)(iVar2 + 4) == (&DAT_00018358)[iVar3 * 7]) {
      iVar4 = param_1;
    }
    if (param_2 != (int *)0x0) {
      *param_2 = (int)(&DAT_00018350 + iVar3 * 7);
      (&DAT_00018360)[iVar3 * 7] = (&DAT_00018360)[iVar3 * 7] + 1;
      param_2[1] = iVar4;
    }
    if (param_3 != (int *)0x0) {
      *param_3 = iVar4;
      ...
      *(undefined2 *)(param_3 + 2) = *(undefined2 *)(&DAT_00018364 + iVar3 * 7);
      return 0;
    }
    return 0;
  }
