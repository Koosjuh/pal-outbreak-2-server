...
CALLEES (6): FUN_00013650@0x00013650, FUN_00011d48@0x00011d48, FUN_00013e24@0x00013e24, FUN_00013bfc@0x00013bfc, FUN_00014e24@0x00014e24, FUN_00013a2c@0x00013a2c
    ...
    if (*(int *)(iVar11 + 4) == 2) {
        ...
        if (uVar14 != 0) {
          ...
          do {
            ...
            if ((CONCAT11(*puVar5,puVar5[1]) == 0xc) && (CONCAT11(puVar5[2],puVar5[3]) == 1)) {
              ...
              DAT_00017bb4 = *(undefined4 *)(iVar11 + 0xc20);
              iVar13 = 0;
            }
            else {
      ...
      *(undefined4 *)(iVar11 + 4) = 1;
      ...
      if (*(int *)(iVar11 + 0x814) < iVar3) {
        ...
        uVar7 = (&DAT_00017ba8)[*(int *)(iVar11 + 0xc20)];
