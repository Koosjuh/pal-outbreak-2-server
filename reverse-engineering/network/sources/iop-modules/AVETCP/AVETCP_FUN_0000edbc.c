...

{
  ...
  if (DAT_0001619a != 0) {
    ...
    do {
      sVar1 = (short)iVar3;
      iVar2 = iVar2 >> 0x10;
      if (((&DAT_00018350)[iVar2 * 7] == param_1) && ((&DAT_00018358)[iVar2 * 7] == param_3)) {
        if (param_4 == '\x01') {
LAB_0000ee40:
          if ((&DAT_00018369)[iVar2 * 0x1c] != '\x01') goto LAB_0000ee64;
        }
        else if ((&DAT_00018369)[iVar2 * 0x1c] == '\x01') {
          if (param_4 != '\x01') goto LAB_0000ee64;
          goto LAB_0000ee40;
        }
        if (((&DAT_0001835e)[iVar2 * 0xe] & 1) != 0) {
          puVar4 = &DAT_00018350 + sVar1 * 7;
          break;
        }
      }
LAB_0000ee64:
