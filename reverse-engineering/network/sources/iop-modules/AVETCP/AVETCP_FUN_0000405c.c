...

{
  ...
  iVar3 = param_4 * 0x2c;
  if ((&DAT_00028881)[iVar3] == '\x02') {
    uVar2 = 0xffffffff;
  }
  else {
    (&DAT_00028884)[param_4 * 0xb] = param_1;
    *(uint *)(&DAT_0002888c + iVar3) = param_1 & param_2;
    *(undefined4 *)(&DAT_00028888 + iVar3) = param_3;
    *(uint *)(&DAT_00028890 + iVar3) = param_2;
    sVar1 = FUN_0000e7ec();
    uVar2 = 0xffffffff;
    if (sVar1 == 0) {
      uVar2 = 0;
